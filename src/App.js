      ...
      <div className="container mx-auto flex-col flex text-left mt-3">
        ...
        <div className="flex-col mt-3">
          ...
          <div className="flex justify-between mt-4 items-center h-full text-sm font-light">
            <p className="mx-3 px-5 border-r w-1/3 h-full border-gray-200 text-gray-600 hover:text-black">
              아들이자 남편이고 아빠이며<br/>
              Web시스템 개발자이며<br/>
            ...
            <p className="mx-3 p-5 border-r w-1/3 h-full  border-gray-200 text-gray-600 hover:text-black">
              시스템/홈페이지/각종 개발이 필요하실 때<br/>
              컨설팅과 견적이 필요하실 때<br/>
              친절하고 적극적으로 상담해 드립니다.
            </p>
            <p className="mx-3 p-5 w-1/3 text-gray-600 hover:text-black">
              본 홈페이지는 <br/>
        ...
        <div className="flex-col mt-5 w-1/2">
