const footer = () => {
    return (
        <div className="w-full border-t border-gray-200 mt-8 flex flex-col md:flex-row items-center justify-items-center text-center mx-auto py-5 font-light text-gray-500">
            <p className="md:w-1/3">
                <a href="mailto:soundbrokaz@kakao.com"><i className="fas fa-envelope mr-2"></i>soundbrokaz@kakao.com</a>
            </p>
            <p className="md:w-1/3 my-3 md:my-10">
